...
## Type: ShellCommand
c.editor.command = ['nvim', '{file}:{line}:{column0}']
...
## Type: Padding
c.tabs.padding = {'top': 0, 'bottom': 0, 'left': 3, 'right': 3}
...
## Type: Dict
c.url.searchengines = {'DEFAULT': 'https://google.com/search?q={}', 'google': 'https://google.com/search?q={}', "archwiki": "https://wiki.archlinux.org/?search={}", 'g': 'https://google.com/search?q={}', "aw": "https://wiki.archlinux.org/?search={}"}
...
## Type: FormatString
c.window.title_format = 'qutebrowser{title_sep}{title}'
...
config.bind('<Ctrl-S>', 'insert-text {clipboard}', mode='insert')
