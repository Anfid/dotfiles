...
nmap <leader>lgd <Cmd>TagImposterAnticipateJump<CR><Plug>(coc-definition)
nmap <leader>lgc <Cmd>TagImposterAnticipateJump<CR><Plug>(coc-declaration)
nmap <leader>lgi <Cmd>TagImposterAnticipateJump<CR><Plug>(coc-implementation)
nmap <leader>lgr <Cmd>TagImposterAnticipateJump<CR><Plug>(coc-references)
